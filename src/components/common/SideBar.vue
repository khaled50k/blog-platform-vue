...
<template>
    <div class="">
        <div class="  max-h-full m-w-auto flex-1 w-full ">
            <div class="flex-1 flex flex-col   overflow-y-auto gap-5   w-full">
...
export default {
    ...
    setup() {
        ...
        return {
            notificationCount, navigation, showCreatePostModal, toggleShowCreatePostModal, updateDialogState
        }
    },
}
</script>
