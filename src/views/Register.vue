    ...
    <div class="w-full sm:w-[450px] h-screen">
      <div class="bg-white p-4 sm:p-6 flex flex-col  rounded-xl ">
        ...
        <div class="flex  mb-4 py-1 items-center  flex-col w-full gap-5">
          ...
          <h2 class="text-2xl font-semibold text-gray-800 text-center">Get Started</h2>
          <input type="text"
          ...
          <button @click="login" class="w-full px-4 py-2 rounded-md bg-primary text-white font-semibold hover:bg-opacity-90 mt-4">Sign up</button>
          <p class="text-gray-600 text-sm mt-2">Have an account? <router-link to="/login" class="text-primary">Sign in</router-link></p>
...
import Header from "../components/common/Header.vue";
    ...
    const user = ref({ username: '', passowrd: '' ,email:'',name:''});
    const login = async () => {
      try {
